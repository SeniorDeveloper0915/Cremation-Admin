<?php
    ...
    $getHelp = $db->prepare("SELECT * FROM help_center");
    $getHelp->execute();
    $rowHelp = $getHelp->fetchAll();
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green">
                        ...
                        <span class="caption-subject bold uppercase">帮助中心管理</span>
                    </div>
                </div>
                <form id="helpCreate" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-1">
                                            <label for="content">帮助中心内容 : </label>        
                                        </div>
                                        <div class="col-sm-9">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn green btn-outline" name="submit" onclick="createHelp();return false">保存</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    function createHelp() {
        ...
        $.easyAjax({
            url: "../../ajax/help_center/add_help.php",
            type: "POST",
            container: "#helpCreate",
            data : {
