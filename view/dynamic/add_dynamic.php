...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <form id="dynamicCreate" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn green btn-outline" name="submit" onclick="createDynamic();return false">保存</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function createDynamic() {
        ...
        if (document.getElementById('title').value == "") {
            window.alert("Input Dynamic Title");
            return false;
        }

        if (document.getElementById('subtitle').value == "") {
            window.alert("Input Dynamic Sub Title");
            return false;
        }

        if (document.getElementById('dynamicimg').value == "") {
            window.alert("Select Dynamic Image");
            return false;
        }

        if (CKEDITOR.instances.content.getData() == "") {
            window.alert("Input Dynamic Content");
            return false;
        }
        ...
        $.easyAjax({
            url: "../../ajax/dynamic/add_dynamic.php",
            type: "POST",
            container: "#dynamicCreate",
            data : {
