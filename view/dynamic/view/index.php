\<?php
    ...
    $dynamicimg = file_exists("../../../images/dynamic/".$rowBanner['Dynamic_Img']);
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="title" name="title" class="form-control input-sm" data-required="true"
                                    value="<?php echo $rowDynamic['Dynamic_Title'] ?>" disabled="true">        
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="subtitle" name="subtitle" class="form-control input-sm"
                                    data-required="true" value="<?php echo $rowDynamic['Dynamic_Subtitle'] ?>" disabled="true">        
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" id="sort" name="sort" class="form-control input-sm"
                                    data-required="true" value="<?php echo $rowDynamic['Sort'] ?>" disabled="true">        
                            </div>
                        </div>
                    </div>
                </div>
