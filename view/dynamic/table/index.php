...
<script>
    ...
    var table = $('#dynamicTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/dynamic/view/index.php",
        "aoColumns": [
    ...
    function editDynamic(id) {
        deleteCookie();
        document.cookie = "dynamic_id = " + id + ";path=/hy_admin/view/dynamic/edit";
        window.location.href = "../edit/index.php";
    }

    function viewDynamic(id) {
        deleteCookie();
        document.cookie = "dynamic_id=" + id + ";path=/hy_admin/view/dynamic/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/dynamic/status/index.php?id=" + id,
    ...
    function deleteDynamic(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../../ajax/dynamic/delete/index.php?id=" + id,
