...
<script>
    var table = $('#bannerTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../ajax/banner/banner_view.php",
        "aoColumns": [
    ...
    function editBanner(id) {
        deleteCookie
        document.cookie = "banner_id=" + id;
        window.location.href = "edit_banner.php";
    }
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../ajax/banner/change_status.php?id=" + id,
    ...
    function deleteBanner(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../ajax/banner/delete_banner.php?id=" + id,
