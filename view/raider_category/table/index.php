...
<script>
    ...
    var table = $('#categoryTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/raider_category/view/index.php",
        "aoColumns": [
    ...
    function editCategory(id) {
        deleteCookie();
        document.cookie = "category_id = " + id + ";path=/hy_admin/view/raider_category/edit";
        window.location.href = "../edit/index.php";
    }

    function viewCategory(id) {
        deleteCookie();
        document.cookie = "category_id=" + id + ";path=/hy_admin/view/raider_category/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/raider_category/status/index.php?id=" + id,
    ...
    function deleteCategory(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../../ajax/raider_category/delete/index.php?id=" + id,
