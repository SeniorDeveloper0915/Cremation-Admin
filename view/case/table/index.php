            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green">
                        ...
                        <span class="caption-subject bold uppercase">医院管理</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addCase()"> 添加案例 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="caseTable" style="text-align: center;">
                        <thead>
                        <tr>
                            <th class="min-tablet" style="text-align: center;">序号</th>
                            <th class="min-tablet" style="text-align: center;">医院名称</th>
                            <th class="min-tablet" style="text-align: center;">案例标题</th>
...
<script>
    var table = $('#caseTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/case/view/index.php",
        "aoColumns": [
    ...
    function deleteCookie() {
        ...
        window.document.cookie = "case_id=" + "; " + expires;//Set the cookie with name and the expiration date
    }

    function editCase(id) {
        deleteCookie();
	    document.cookie = "case_id = " + id + ";path=/hy_admin/view/case/edit";
        window.location.href = "../edit/index.php";
    }

    function viewCase(id) {
        deleteCookie();
        document.cookie = "case_id=" + id + ";path=/hy_admin/view/case/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/case/status/index.php?id=" + id,
    ...
    function deleteCase(id) {
        ...
        $('#deleteModal').find(".modal-body").html('Are you sure ! You want to delete this hospital case');
        $('#deleteModal').appendTo("body").modal('show');
        $("#delete").click(function () {

            $.easyAjax({
                type: "POST",
                url: "../../../ajax/case/delete/index.php?id=" + id,
