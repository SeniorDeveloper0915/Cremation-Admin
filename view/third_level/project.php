...
<script>
    var table = $('#projectTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../ajax/third_level/project_view.php",
        "aoColumns": [
    ...
    function editProject(id) {
        ...
        window.location.href = "edit_project.php";
    }
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../ajax/third_level/change_status.php?id=" + id,
    ...
    function deleteProject(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../ajax/third_level/delete_project.php?id=" + id,
