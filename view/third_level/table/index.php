                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addProject()"> 添加三级项目 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="projectTable" style="text-align: center;">
                        <thead>
                        <tr>
                            <th class="min-tablet" style="text-align: center;">序号</th>
                            <th class="min-tablet" style="text-align: center;">一级项目名称</th>
                            <th class="min-tablet" style="text-align: center;">二级项目名称</th>
                            <th class="min-tablet" style="text-align: center;">三级项目名称</th>
...
<script>
    var table = $('#projectTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/third_level/view/index.php",
        "aoColumns": [
    ...
    function deleteCookie() {
        ...
        window.document.cookie = "project_id=" + "; " + expires;//Set the cookie with name and the expiration date
    }

    function editProject(id) {
        deleteCookie();
        document.cookie = "project_id=" + id + ";path=/hy_admin/view/third_level/edit";
        window.location.href = "../edit/index.php";
    }

    function viewProject(id) {
        deleteCookie();
        document.cookie = "project_id=" + id + ";path=/hy_admin/view/third_level/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/third_level/status/index.php?id=" + id,
    ...
    function deleteProject(id) {
        ...
        $('#deleteModal').find(".modal-body").html('Are you sure ! You want to delete this project');
        $('#deleteModal').appendTo("body").modal('show');
        $("#delete").click(function () {

            $.easyAjax({
                type: "POST",
                url: "../../../ajax/third_level/delete/index.php?id=" + id,
