...
<script>
    ...
    var table = $('#raiderTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../ajax/raider/raider_view.php",
        "aoColumns": [
    ...
    function addRaider() {
        window.location.href = "add_raider.php";
    }
    ...
    function viewRaider(id) {
        deleteCookie();
        document.cookie = "raider_id=" + id;
        window.location.href            = "view_raider.php"
    }

    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../ajax/raider/change_status.php?id=" + id,
    ...
    function deleteRaider(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../ajax/raider/delete_raider.php?id=" + id,
