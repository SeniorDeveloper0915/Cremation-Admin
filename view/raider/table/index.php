                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addRaider()"> 添加攻略 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="raiderTable" style="text-align: center;">
                        <thead>
                        <tr>
                            <th class="min-tablet" style="text-align: center;">序号</th>
                            <th class="min-tablet" style="text-align: center;">攻略标题</th>
                            <th class="min-tablet" style="text-align: center;">二级标题</th>
...
<script>
    ...
    var table = $('#raiderTable').dataTable({
        "bProcessing": true,
        "bServerSide": true,
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/raider/view/index.php",
        "aoColumns": [
    ...
    function deleteCookie() {
        ...
        window.document.cookie = "raider_id=" + "; " + expires;//Set the cookie with name and the expiration date
    }

    function editRaider(id) {
        deleteCookie();
        document.cookie = "raider_id = " + id + ";path=/hy_admin/view/raider/edit";
        window.location.href = "../edit/index.php";
    }

    function viewRaider(id) {
        deleteCookie();
        document.cookie = "raider_id=" + id + ";path=/hy_admin/view/raider/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/raider/status/index.php?id=" + id,
    ...
    function deleteRaider(id) {

        $('#deleteModal').find(".modal-body").html('Are you sure ! You want to delete this raider');
        $('#deleteModal').appendTo("body").modal('show');
        $("#delete").click(function () {

            $.easyAjax({
                type: "POST",
                url: "../../../ajax/raider/delete/index.php?id=" + id,
