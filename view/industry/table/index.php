                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addIndustry()"> 添加资讯 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="industryTable" style="text-align: center;">
                        <thead>
                        <tr>
...
<script>
    var table = $('#industryTable').dataTable({
        "bProcessing": true,
        "bServerSide": true,
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/industry/view/index.php",
        "aoColumns": [
    ...
    function editIndustry(id) {
        deleteCookie();
        document.cookie = "industry_id = " + id + ";path=/hy_admin/view/industry/edit";
        window.location.href = "../edit/index.php";
    }

    function viewIndustry(id) {
        deleteCookie();
        document.cookie = "industry_id=" + id + ";path=/hy_admin/view/industry/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/industry/status/index.php?id=" + id,
    ...
    function deleteIndustry(id) {
        ...
        $('#deleteModal').find(".modal-body").html('Are you sure ! You want to delete this industry');
        $('#deleteModal').appendTo("body").modal('show');
        $("#delete").click(function () {

            $.easyAjax({
                type: "POST",
                url: "../../../ajax/industry/delete/index.php?id=" + id,
