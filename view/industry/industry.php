...
<script>
    var table = $('#industryTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../ajax/industry/industry_view.php",
        "aoColumns": [
    ...
    function addIndustry() {
        window.location.href = "add_industry.php";
    }
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../ajax/industry/change_status.php?id=" + id,
    ...
    function deleteIndustry(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../ajax/industry/delete_industry.php?id=" + id,
