                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addProject()"> 添加一级项目 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
...
<script>
    var table = $('#projectTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/first_level/view/index.php",
        "aoColumns": [
    ...
    function editProject(id) {
        deleteCookie();
        document.cookie = "project_id=" + id + ";path=/hy_admin/view/first_level/edit";
        window.location.href = "../edit/index.php";
    }

    function viewProject(id) {
        deleteCookie();
        document.cookie = "project_id=" + id + ";path=/hy_admin/view/first_level/view";
    ...
    function deleteProject(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../../ajax/first_level/delete/index.php?id=" + id,
