...
<script>
    ...
    function updateProject() {
        if (document.getElementById('projectname').value != "" && document.getElementById('sort').value != "" && document.getElementById('sort').value <= 100) {
            $.easyAjax({
                type: "POST",
                url: "../../ajax/first_level/edit_project.php",
