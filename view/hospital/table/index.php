                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addHospital()"> 添加医院 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="hospitalTable" style="text-align: center;">
                        <thead>
                        <tr>
                            <th class="min-tablet" style="text-align: center;">序号</th>
                            <th class="min-tablet" style="text-align: center;">医院名称</th>
                            <th class="min-tablet" style="text-align: center;">医院资质</th>
                            <th class="min-tablet" style="text-align: center;">医院等级</th>
                            <th class="min-tablet" style="text-align: center;">医疗许可证号</th>
...
<script>
    ...
    var table = $('#hospitalTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/hospital/view/index.php",
        "aoColumns": [
    ...
    function editHospital(id) {
        deleteCookie();
        document.cookie = "hospital_id = " + id + ";path=/hy_admin/view/hospital/edit";
        window.location.href = "../edit/index.php";
    }

    function viewHospital(id) {
        deleteCookie();
        document.cookie = "hospital_id=" + id + ";path=/hy_admin/view/hospital/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/hospital/status/index.php?id=" + id,
    ...
    function deleteHospital(id) {
        ...
        $('#deleteModal').find(".modal-body").html('Are you sure ! You want to delete this hospital');
        $('#deleteModal').appendTo("body").modal('show');
        $("#delete").click(function () {

            $.easyAjax({
                type: "POST",
                url: "../../../ajax/hospital/delete/index.php?id=" + id,
