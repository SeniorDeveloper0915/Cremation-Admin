        ...
        <div class="page-content">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover dt-responsive" id="requestTable">
                            <thead>
                            <tr>
                                <th class="min-tablet">Id</th>
                                <th class="min-tablet">Requester</th>
                                <th class="min-tablet">Sender</th>
                                <th class="min-tablet">Receiver</th>
...
<script>
    // Show requests datatable
    var table = $('#requestTable').dataTable({
        "bProcessing": true,
        "bServerSide": true,
        "sServerMethod": "GET",
        "aaSorting": [[0, "desc"]],
        "sAjaxSource": "../ajax/request_view.php",
        "aoColumns": [
