    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <div class="portlet light bordered" class="col-md-10">
                ...
                <form id="titleCreate" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn green btn-outline" name="submit" onclick="createTitle();return false">保存</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    function createTitle() {
        ...
        $.easyAjax({
            url: "../../../ajax/doctor_title/add/index.php",
            type: "POST",
