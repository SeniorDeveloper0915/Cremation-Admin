            ...
            <div class="portlet light bordered">
                ...
                <form id="titleUpdate" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="hidden" name="id" value="<?php echo $rowTitle['id'] ?>">
                                            <input type="text" id="title" name="title" class="form-control input-sm" data-required="true"
                                                value="<?php echo $rowTitle['Doctor_Title'] ?>">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn green btn-outline" name="submit" onclick="updateTitle();return false">保存</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    function updateTitle() {
        $.easyAjax({
            type: "POST",
            url: "../../../ajax/doctor_title/edit/index.php",
            container: "#titleUpdate",
            file:true,
