                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addTitle()"> 添加职称 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="titleTable" style="text-align: center;">
                        <thead>
                        <tr>
                            <th class="min-tablet" style="text-align: center;">序号</th>
                            <th class="min-tablet" style="text-align: center;">职称名称</th>
...
<script>
    var table = $('#titleTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/doctor_title/view/index.php",
        "aoColumns": [
    ...
    function deleteCookie() {
        ...
        window.document.cookie = "title_id=" + "; " + expires;//Set the cookie with name and the expiration date
    }

    function editTitle(id) {
        deleteCookie();
        document.cookie = "title_id=" + id + ";path=/hy_admin/view/doctor_title/edit";
        window.location.href = "../edit/index.php";
    }

    function viewTitle(id) {
        deleteCookie();
        document.cookie = "title_id=" + id + ";path=/hy_admin/view/doctor_title/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/first_level/status/index.php?id=" + id,
    ...
    function deleteTitle(id) {
        ...
        $('#deleteModal').find(".modal-body").html('Are you sure ! You want to delete this doctor title');
        $('#deleteModal').appendTo("body").modal('show');
        $("#delete").click(function () {

            $.easyAjax({
                type: "POST",
                url: "../../../ajax/doctor_title/delete/index.php?id=" + id,
