...
<script>
    var table = $('#titleTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../ajax/doctor_title/title_view.php",
        "aoColumns": [
    ...
    function editTitle(id) {
        deleteCookie();
        document.cookie = "title_id=" + id;
        window.location.href = "edit_title.php";
    }

    function viewTitle(id) {
        deleteCookie();
        document.cookie = "title_id=" + id;
        window.location.href = "view_title.php";
    }

    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../ajax/first_level/change_status.php?id=" + id,
    ...
    function deleteTitle(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../ajax/doctor_title/delete_title.php?id=" + id,
