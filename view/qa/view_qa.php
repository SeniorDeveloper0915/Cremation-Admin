        ...
        <div class="page-content">
            <div class="portlet light bordered">
                ...
                <div class="form-group form-md-line-input form-md-floating-label">
                    <div class="row">
                        <div class="col-sm-1">
                            <label for="qcontent">提问时间 : </label>        
                        </div>
                        <div class="col-sm-9">
                            <input type="text" id="qtitle" name="qtitle" class="form-control input-sm" data-required="true"
                                value="<?php echo $rowQa['Question_Time'] ?>" disabled="true">
                        </div>
                    </div>
                </div>
                ...
                <form id="answer" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-md-line-input form-md-floating-label">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="doctorid" name="doctorid" disabled="" disabled="true">
                                    <?php
                                        foreach ($rowDoctor as $value) {
                                            if ($value['id'] == $rowQa['Doctor_Id'])
                                            {
                                    ?>
...
<script>
    ...
    $(document).ready(function () {
        $("#content").html('<?php echo $rowQa["Answer_Content"]; ?>');
    });
