            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green">
                        ...
                        <span class="caption-subject bold uppercase">问答管理</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="qaTable" style="text-align: center;">
                        <thead>
                        <tr>
                            <th class="min-tablet" style="text-align: center;"序号</th>
                            <th class="min-tablet" style="text-align: center;">用户手机</th>
                            <th class="min-tablet" style="text-align: center;">标题</th>
                            <th class="min-tablet" style="text-align: center;">内容</th>
                            <th class="min-tablet" style="text-align: center;">提问时间</th>
                            <th class="min-tablet" style="text-align: center;">答复时间</th>
                            <th class="min-tablet" style="text-align: center;">阅读量</th>
                            <th class="min-tablet" style="text-align: center;">答复状态</th>
...
<script>
    ...
    var table = $('#qaTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/qa/view/index.php",
        "aoColumns": [
    ...
    function deleteCookie() {
        ...
        window.document.cookie = "qa_id=" + "; " + expires;//Set the cookie with name and the expiration date
    }

    function answer(id) {
        deleteCookie();
        document.cookie = "qa_id = " + id + ";path=/hy_admin/view/qa/answer";
        window.location.href = "../answer/index.php";
    }

    function view(id) {
        deleteCookie();
        document.cookie = "qa_id=" + id + ";path=/hy_admin/view/qa/view";
        window.location.href            = "../view/index.php"
    }

    function deleteQa(id) {

        $('#deleteModal').find(".modal-body").html('Are you sure ! You want to delete this question & answer');
        $('#deleteModal').appendTo("body").modal('show');
        $("#delete").click(function () {

            $.easyAjax({
                type: "POST",
                url: "../../../ajax/qa/delete/index.php?id=" + id,
