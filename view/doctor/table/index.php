            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green">
                        ...
                        <span class="caption-subject bold uppercase">医生管理</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addDoctor()"> 添加医生 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="doctorTable" style="text-align: center;">
                        <thead>
                        <tr>
                            <th class="min-tablet" style="text-align: center;">序号</th>
                            <th class="min-tablet" style="text-align: center;">医生名称</th>
                            <th class="min-tablet" style="text-align: center;">职称</th>
                            <th class="min-tablet" style="text-align: center;">职业年限</th>
                            <th class="min-tablet" style="text-align: center;">资格证号</th>
...
<script>
    ...
    var table = $('#doctorTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/doctor/view/index.php",
        "aoColumns": [
    ...
    function deleteCookie() {
        ...
        window.document.cookie = "doctor_id=" + "; " + expires;//Set the cookie with name and the expiration date
    }

    function editDoctor(id) {
        deleteCookie()
        document.cookie = "doctor_id = " + id + ";path=/hy_admin/view/doctor/edit";
        window.location.href = "../edit/index.php";
    }

    function viewDoctor(id) {
        deleteCookie();
        document.cookie = "doctor_id=" + id + ";path=/hy_admin/view/doctor/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/doctor/status/index.php?id=" + id,
    ...
    function deleteDoctor(id) {
        ...
        $('#deleteModal').find(".modal-body").html('Are you sure ! You want to delete this doctor');
        $('#deleteModal').appendTo("body").modal('show');
        $("#delete").click(function () {

            $.easyAjax({
                type: "POST",
                url: "../../../ajax/doctor/delete/index.php?id=" + id,
