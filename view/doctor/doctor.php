...
<script>
    ...
    var table = $('#doctorTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../ajax/doctor/doctor_view.php",
        "aoColumns": [
    ...
    function editDoctor(id) {
        deleteCookie()
        document.cookie = "doctor_id = " + id;
        window.location.href = "edit_doctor.php";
    }
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../ajax/doctor/change_status.php?id=" + id,
    ...
    function deleteDoctor(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../ajax/doctor/delete_doctor.php?id=" + id,
