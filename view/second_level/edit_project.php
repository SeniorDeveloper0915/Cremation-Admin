...
<script>
    function updateProject() {
        if (document.getElementById('firstid').value != "" && document.getElementById('projectname').value != "" && document.getElementById('sort').value != "" && document.getElementById('sort').value <= 100) {
                $.easyAjax({
                    type: "POST",
                    url: "../../ajax/second_level/edit_project.php",
