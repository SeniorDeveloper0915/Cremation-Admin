                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addProject()"> 添加二级项目 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
...
<script>
    var table = $('#projectTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/second_level/view/index.php",
        "aoColumns": [
    ...
    function editProject(id) {
        deleteCookie();
        document.cookie = "project_id=" + id + ";path=/hy_admin/view/second_level/edit";
        window.location.href = "../edit/index.php";
    }

    function viewProject(id) {
        deleteCookie();
        document.cookie = "project_id=" + id + ";path=/hy_admin/view/second_level/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/second_level/status/index.php?id=" + id,
    ...
    function deleteProject(id) {
        ...
        $("#delete").click(function () {
            ...
            $.easyAjax({
                type: "POST",
                url: "../../../ajax/second_level/delete/index.php?id=" + id,
