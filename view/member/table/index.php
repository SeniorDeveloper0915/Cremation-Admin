                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="javascript:;" class="btn green btn-outline" onclick="addMember()"> 添加成员 <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="memberTable" style="text-align: center;">
                        <thead>
                        <tr>
                            <th class="min-tablet" style="text-align: center;">序号</th>
                            <th class="min-tablet" style="text-align: center;">成员名称</th>
...
<script>
    ...
    var table = $('#memberTable').dataTable({
        ...
        "sServerMethod": "GET",
        "aaSorting": [[0, "asc"]],
        "sAjaxSource": "../../../ajax/member/view/index.php",
        "aoColumns": [
    ...
    function deleteCookie() {
        ...
        window.document.cookie = "member_id=" + "; " + expires;//Set the cookie with name and the expiration date
    }

    function editMember(id) {
        deleteCookie();
        document.cookie = "member_id = " + id + ";path=/hy_admin/view/member/edit";
        window.location.href = "../edit/index.php";
    }

    function viewMember(id) {
        deleteCookie();
        document.cookie = "member_id=" + id + ";path=/hy_admin/view/member/view";
    ...
    function changeStatus(id) {
        $.easyAjax({
                type: "POST",
                url: "../../../ajax/member/status/index.php?id=" + id,
    ...
    function deleteMember(id) {
        ...
        $('#deleteModal').find(".modal-body").html('Are you sure ! You want to delete this member');
        $('#deleteModal').appendTo("body").modal('show');
        $("#delete").click(function () {

            $.easyAjax({
                type: "POST",
                url: "../../../ajax/member/delete/index.php?id=" + id,
