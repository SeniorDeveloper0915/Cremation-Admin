 ...
 */
$aColumns = array( 'id','Category_Name', 'Article_Cnt', 'Sort', 'Status', 'Release_Time');
$asColumns = array( 'id','Category_Name', 'Article_Cnt', 'Sort', 'Status', 'Release_Time');
$aaColumns = array( 'id','Category_Name', 'Article_Cnt', 'Sort', 'Status', 'Release_Time');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "id";

/* DB table to use */
$sTable = "raider_category";
        ...
        if($aaColumns[$i] == 'Status') {
            if($aRow[$aaColumns[$i]] == '1') {
                $row[] = '<a href="javascript:;" onclick="changeStatus('.$row[0].')" class="btn btn green btn-outline btn-sm">下架</a>&nbsp;
                          <a href="javascript:;" onclick="viewCategory('.$row[0].')" class="btn btn-outline red btn-sm">查看</a>&nbsp
                          <a href="javascript:;" onclick="editCategory('.$row[0].')" class="btn btn-outline blue btn-sm">修改</a>&nbsp
                          <a href="javascript:;" onclick="deleteCategory('.$row[0].')" class="btn btn-outline black btn-sm">删除</a>';
            } else {
