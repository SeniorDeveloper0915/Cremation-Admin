 ...
 */
$aColumns = array( 'id','Dynamic_Title', 'Sort', 'Status', 'Release_Time');
$asColumns = array( 'id','Dynamic_Title', 'Sort', 'Status', 'Release_Time');
$aaColumns = array( 'id','Dynamic_Title', 'Sort', 'Status', 'Release_Time');
        ...
        if($aaColumns[$i] == 'Status') {
            if($aRow[$aaColumns[$i]] == '1') {
                $row[] = '<a href="javascript:;" onclick="changeStatus('.$row[0].')" class="btn btn green btn-outline btn-sm">下架</a>&nbsp;
                          <a href="javascript:;" onclick="viewDynamic('.$row[0].')" class="btn btn-outline red btn-sm">查看</a>&nbsp
                          <a href="javascript:;" onclick="editDynamic('.$row[0].')" class="btn btn-outline blue btn-sm">修改</a>&nbsp
                          <a href="javascript:;" onclick="deleteDynamic('.$row[0].')" class="btn btn-outline black btn-sm">删除</a>';
            } else {
