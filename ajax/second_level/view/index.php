 ...
 */
$aColumns = array( 'id', 'First_Project_Id', 'Project_Name', 'Sort', 'Status', 'Release_Time');
$asColumns = array( 'id', 'First_Project_Id', 'Project_Name', 'Sort', 'Status', 'Release_Time');
$aaColumns = array( 'id', 'First_Project_Id', 'Project_Name', 'Sort', 'Status', 'Release_Time');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "id";

/* DB table to use */
$sTable = "second_project";
