 ...
 */
$aColumns = array( 'id','Project_Name', 'Sort', 'Status', 'Release_Time');
$asColumns = array( 'id','Project_Name', 'Sort', 'Status', 'Release_Time');
$aaColumns = array( 'id','Project_Name', 'Sort', 'Status', 'Release_Time');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "id";

/* DB table to use */
$sTable = "first_project";
