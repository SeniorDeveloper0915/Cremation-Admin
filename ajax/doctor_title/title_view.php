 ...
 */
$aColumns = array( 'id','Doctor_Title', 'Sort', 'Release_Time');
$asColumns = array( 'id','Doctor_Title', 'Sort', 'Release_Time');
$aaColumns = array( 'id','Doctor_Title', 'Sort', 'Release_Time');
...
while ( $aRow = mysqli_fetch_array( $rResult ) )
{
    ...
    for ($i = 0; $i < count($aaColumns); $i ++)
    {
        ...
        $row[] = '<a href="javascript:;" onclick="viewTitle('.$row[0].')" class="btn btn-outline red btn-sm">查看</a>&nbsp
                  <a href="javascript:;" onclick="editTitle('.$row[0].')" class="btn btn-outline blue btn-sm">修改</a>&nbsp
                  <a href="javascript:;" onclick="deleteTitle('.$row[0].')" class="btn btn-outline black btn-sm">删除</a>';
    }
